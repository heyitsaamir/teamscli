...
export const RSC_PERMISSIONS_TEAM: RscPermissionGroup = {
  Application: [
    ...
    },
    {
      ...
      description: "Allows the app to read basic properties, such as name, schedule, organizer, join link, and start/end notifications, of channel meetings in this team, without a signed-in user.",
    },
    {
      name: "ChannelMeetingParticipant.Read.Group",
      displayName: "Read the participants of this team's channel meetings",
      description: "Allows the app to read participant information, including name, role, id, joined and left times, of channel meetings associated with this team, without a signed-in user.",
    },
    {
      name: "ChannelMeetingRecording.Read.Group",
      displayName: "Read the recordings of all channel meetings associated with this team",
      description: "Allows the app to read the recordings of all channel meetings associated with this team.",
    },
    {
      ...
      description: "Allows the app to read the transcripts of all channel meetings associated with this team.",
    },
    {
      ...
      description: "Allows the app to send notifications inside all the channel meetings associated with this team, without a signed-in user.",
    },
    {
    ...
    },
    {
      ...
      description: "Allows the app to read this team's channel's messages, without a signed-in user.",
    },
    {
    ...
    },
    {
      ...
      description: "Allows the app to read this team's channel names, channel descriptions, and channel settings, without a signed-in user.",
    },
    {
      name: "ChannelSettings.ReadWrite.Group",
      displayName: "Update the names, descriptions, and settings of this team's channels",
      description: "Allows the app to update and read the names, descriptions, and settings of this team's channels, without a signed-in user.",
    },
    {
    ...
    },
    {
      ...
      description: "Allows the app to read the basic profile of this group's owners, without a signed-in user.",
    },
    {
      name: "TeamsActivity.Send.Group",
      displayName: "Send activity feed notifications to users in this team",
      description: "Allows the app to create new notifications in the teamwork activity feeds of the users in this team, without a signed-in user.",
    },
    {
      name: "TeamsAppInstallation.Read.Group",
      displayName: "Read which apps are installed in this team",
      description: "Allows the app read the Teams apps that are installed in this team, without a signed-in user.",
    },
    {
    ...
    },
    {
      ...
      description: "Allows the app to read and write this team's settings, without a signed-in user.",
    },
    {
  ...
  Delegated: [
    {
      ...
      description: "Allows the app to read participants who are currently sending audio into the channel meetings associated with this team, on behalf of the signed-in user.",
    },
    {
      ...
      description: "Allows the app to stream audio-video content of channel meetings associated with this team, on behalf of the signed-in user.",
    },
    {
      name: "ChannelMeetingIncomingAudio.Detect.Group",
      displayName: "Detect incoming audio in meetings associated with this team",
      description: "Allows the app to detect changes in the status of incoming audio in meetings associated with this team, on behalf of the signed-in user.",
    },
    {
      name: "ChannelMeetingStage.Write.Group",
      displayName: "Show content on the meeting stage of channel meetings associated with this team",
      description: "Allows the app to show content on the meeting stage in channel meetings associated with this team, on behalf of the signed-in user.",
    },
    {
      name: "InAppPurchase.Allow.Group",
      displayName: "Show and complete in-app purchases for users in this team",
      description: "Allow the app to show marketplace offers to users in this team and complete their purchases within the app, on behalf of the signed-in user.",
    },
    {
      name: "LiveShareSession.ReadWrite.Group",
      displayName: "Create and synchronize Live Share sessions for this team",
      description: "Allows the app to create and synchronize Live Share sessions for this team, and access related information about the roster, such as member's role, on behalf of the signed-in user.",
    },
    {
      ...
      description: "Allows the app to read reactions of participants in channel meetings associated with this team, on behalf of the signed-in user.",
    },
  ],
};
  ...
  Application: [
    {
      ...
      description: "Allows the app to access media streams in calls associated with this chat or meeting, without a signed-in user.",
    },
    {
      name: "Calls.JoinGroupCalls.Chat",
      displayName: "Join calls associated with this chat or meeting",
      description: "Allows the app to join calls associated with this chat or meeting, without a signed-in user.",
    },
    {
    ...
    },
    {
      ...
      description: "Allows the app to read and write this chat's settings, without a signed-in user.",
    },
    {
    ...
    },
    {
      ...
      description: "Allows the app to read the ID of the last message seen by the users in this chat.",
    },
    {
    ...
    },
    {
      ...
      description: "Allows the app to manage the chat, the chat's members and grant access to the chat's data, without a signed-in user.",
    },
    {
    ...
    },
    {
      ...
      description: "Allows the app read the Teams apps that are installed in this chat along with the permissions granted to each app, without a signed-in user.",
    },
    {
      name: "TeamsActivity.Send.Chat",
      displayName: "Send activity feed notifications to users in this chat",
      description: "Allows the app to create new notifications in the teamwork activity feeds of the users in this chat, without a signed-in user.",
    },
    {
    ...
    },
    {
      ...
      description: "Allows the app to read basic properties, such as name, schedule, organizer, join link, and start/end notifications, of a meeting associated with this chat, without a signed-in user.",
    },
    {
    ...
    },
    {
      ...
      description: "Allows the app to send notifications inside meetings associated with this chat, without a signed-in user.",
    },
    {
      name: "OnlineMeetingParticipant.Read.Chat",
      displayName: "Read the participants of meetings associated with this chat",
      description: "Allows the app to read participant information, including name, role, id, joined and left times, of meetings associated with this chat, without a signed-in user.",
    },
  ],
  Delegated: [
    {
      ...
      description: "Allow the app to show marketplace offers to the users in this chat, and any associated meeting, and complete their purchases within the app, on behalf of the signed-in user.",
    },
    {
      name: "LiveShareSession.ReadWrite.Chat",
      displayName: "Create and synchronize Live Share sessions for this chat",
      description: "Allows the app to create and synchronize Live Share sessions for this chat, and access related information about the roster, such as member's role, on behalf of the signed-in user.",
    },
    {
      name: "MeetingStage.Write.Chat",
      displayName: "Show content on the meeting stage of meetings associated with this chat",
      description: "Allows the app to show content on the meeting stage in meetings associated with this chat, on behalf of the signed-in user.",
    },
    {
      ...
      description: "Allows the app to read the reactions of participants in meetings associated with this chat.",
    },
    {
      name: "OnlineMeetingIncomingAudio.Detect.Chat",
      displayName: "Detect incoming audio in meetings associated with this chat",
      description: "Allows the app to detect changes in the status of incoming audio in meetings associated with this chat, on behalf of the signed-in user.",
    },
    {
      name: "OnlineMeetingActiveSpeaker.Read.Chat",
      displayName: "Read participants currently sending audio into meetings associated with this chat",
      description: "Allows the app to read the participants who are currently sending audio into the meetings associated with this chat.",
    },
    {
      name: "OnlineMeetingAudioVideo.Stream.Chat",
      displayName: "Stream audio-video content of meetings associated with this chat",
      description: "Allows the app to stream audio-video content of meetings associated with this chat.",
    },
    {
      name: "OnlineMeetingParticipant.Read.Chat",
      displayName: "Read the participants of meetings associated with this chat (delegated)",
      description: "Allows the app to read participant information, including name, role, id, joined and left times, of meeting associated with this chat, on behalf of the signed-in user.",
    },
    {
      name: "OnlineMeetingParticipant.ToggleIncomingAudio.Chat",
      displayName: "Toggle incoming audio for participants in meetings associated with this chat",
      description: "Allows the app to toggle incoming audio for participants in meetings associated with this chat, on behalf of the signed-in user.",
    },
  ],
};
...
export const RSC_PERMISSIONS_USER: RscPermissionGroup = {
  Application: [
    ...
    },
    {
      ...
      description: "Allows the app to read the Teams apps that are installed for this user along with the permissions granted to each app, without a signed-in user.",
    },
  ],
  Delegated: [
    {
      ...
      description: "Allows the app to read the user's camera stream, on behalf of the signed-in user.",
    },
    {
      name: "InAppPurchase.Allow.User",
      displayName: "Show and complete in-app purchases",
      description: "Allow the app to show the user marketplace offers and complete the user's purchases within the app, on behalf of the signed-in user.",
    },
    {
    ...
    },
    {
      ...
      description: "Allows the app to modify the user's outgoing video, on behalf of the signed-in user.",
    },
  ],
};
