...
export const setLangCommand = new Command("set-lang")
  ...
  .argument("[language]", "Set to typescript (ts), csharp (cs), or python (py). Omit to show current value or pick interactively.")
  .option("--json", "[OPTIONAL] Output as JSON")
  .action(wrapAction(async (value: string | undefined, options: SetLangOptions) => {
