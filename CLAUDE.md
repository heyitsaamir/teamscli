...
When adding or renaming commands, menu items, or features, update the corresponding docs in `docs/`. Key files:
- `docs/commands/` — one `.md` per command/subcommand (autogenerated markers reflect `--help` output)
