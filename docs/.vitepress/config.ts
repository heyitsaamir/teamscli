        ...
        items: [
          ...
          { text: "status", link: "/commands/status" },
          {
            ...
            items: [
              ...
              { text: "app auth oauth add", link: "/commands/app/auth-oauth-add" },
              { text: "app auth oauth list", link: "/commands/app/auth-oauth-list" },
              { text: "app auth oauth remove", link: "/commands/app/auth-oauth-remove" },
              { text: "app auth sso setup", link: "/commands/app/auth-sso-setup" },
              { text: "app auth sso list", link: "/commands/app/auth-sso-list" },
              { text: "app auth sso edit", link: "/commands/app/auth-sso-edit" },
              { text: "app auth sso remove", link: "/commands/app/auth-sso-remove" },
            ],
          },
          {
            text: "scaffold",
