...
```bash
teams app edit <appId> --endpoint https://mybot.azurewebsites.net/api/messages
```

Update multiple properties at once:

```bash
teams app edit <appId> --name "New Name" --version "2.0.0" --developer "My Team"
```
